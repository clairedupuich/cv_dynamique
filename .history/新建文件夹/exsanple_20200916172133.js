...
var revenue = parseInt(prompt('combien vous gagnez ?'));
var annee = prompt("c'est le revenue de l'annee: ?")

if((revenue >= 30000)&&(revenue <= 60000) && (annee%400 == 0)) {
    console.log(revenue*(1- 0.1 + 0.05 ));
}
else if((revenue >= 30000)&&(revenue <= 60000) && !(annee%400 == 0)) {
    console.log(revenue*(1- 0.1 ));
else if ((revenue >= 20000)&&(revenue <= 2900) &&(--revenue >= 50000) && (annee%400 == 0)) {
        console.log(revenue*(1-0.2+0.05));
else ((revenue >= 20000)&&(revenue <= 2900) &&(--revenue >= 50000)&& !(annee%400 == 0) ) {
