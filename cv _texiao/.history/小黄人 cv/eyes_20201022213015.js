...
txt.textContent="One Piece,Dragon Ball Z, Gintama et Le Pacte des Yōkai.Chaque anime est un monde indépendant. Ils sont si loin de nous, mais ils nous rappellent de temps en temps de garder notre innocence et notre passion pour la vie .";
tex.addEventListener("mouseover" change);
function change(){
    image1.parentElement.replaceChild(tex1,image1)
}
/* 获取转动的角度
